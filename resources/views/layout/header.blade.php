<head>
    ...
    <meta name="title" content="Stainless Bali - @yield('title')">
    ...
    <meta property="og:title" content="Stainless Bali - @yield('title')">
    ...
    <meta property="twitter:title" content="Stainless Bali - @yield('title')">
