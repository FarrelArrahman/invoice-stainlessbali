            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item ">
                    <a href="{{ route('customers.index') }}" class="nav-link">
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 20 20" class="bi bi-people-fill">
                ...
                <li class="nav-item">
                    ...
                    <div class="multi-level collapse " role="list" id="expenses" aria-expanded="false">
                        <ul class="flex-column nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../../pages/examples/reset-password.html">
                                    <span class="sidebar-text">Bahan</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <span
                        class="nav-link  collapsed  d-flex justify-content-between align-items-center"
                        data-bs-toggle="collapse" data-bs-target="#master-data">
                        <span>
                            <span class="sidebar-icon">
